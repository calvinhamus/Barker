namespace Barker.Data
{
    ...
    public partial class AspNetUser
    {
        ...
        public AspNetUser()
        {
            ...
            Barks = new HashSet<Bark>();
            UserFollowers = new HashSet<UserFollower>();
            UserFollowers1 = new HashSet<UserFollower>();
            UserFollowings = new HashSet<UserFollowing>();
            UserFollowings1 = new HashSet<UserFollowing>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<UserFollowing> UserFollowings1 { get; set; }
    }
}
